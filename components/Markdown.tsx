...
/**
 * The markdown every note is written in, rendered as React elements. Shared by
 * the garden's Reader and the catalogue's page, so a note reads the same in both.
 */
export type Ctx = {
...
export function Markdown({ body, ctx }: { body: string; ctx: Ctx }) {
  return (
    <div
